...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=java,py,js,react,tailwind,git,github,vim,nginx,docker,kubernetes,aws,grafana,elasticsearch,jenkins,postman,idea,maven,apple,linux,html,css" />
  </a>
</p>

![Skills](https://skillicons.dev/icons?i=java,py,js,react,tailwind,git,github,nginx,docker,kubernetes,aws,grafana,elasticsearch,jenkins,postman,idea,maven,apple,linux,html,css)

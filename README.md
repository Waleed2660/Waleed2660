...
# Tech Stack:
![Skills](https://skillicons.dev/icons?i=java,py,js,react,tailwind,git,github,nginx,kubernetes,grafana,elasticsearch,jenkins,postman,idea,maven,apple,linux,html,css)
